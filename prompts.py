...
FALLBACK_PROMPTS = {
    ...
    "translation": "Translate the following text from {source_language} to {target_language}:\n\n{text}\n\n{dictionary}{grammar}{examples}\n\nOutput only the translated text without any additional explanations or text.",
    "dictionary": "Given the sentence: {text}\nAnd the dictionary content:\n{dictionary}\nExtract relevant word pairs that help translate the sentence from {source_language} to {target_language}. Return ONLY a JSON list of [source_word, target_word] pairs. Do not include any explanations or additional text.",
    "grammar": "Given the sentence: {text}\nAnd the grammar content:\n{grammar}\nExtract 2-3 relevant grammatical statements that help translate the sentence from {source_language} to {target_language}. Return ONLY a JSON list of statements. Do not include any explanations or additional text.",
    "examples": "Given the sentence: {text}\nAnd the translation examples:\n{examples}\nExtract 1-2 relevant translation samples that help translate the sentence from {source_language} to {target_language}. Return ONLY a JSON list of samples. Do not include any explanations or additional text.",
    "retry": "{translation_prompt}\n\nPrevious translation: {initial_translation}\nJudge feedback: {judge_feedback}\nRevise the translation based on the judge's feedback to improve accuracy in meaning, word order, and context.\n\nOutput only the revised translation without any additional explanations or text.",
    "judge": "Review the translation for accuracy in meaning, word order, grammar, and context.\n\nOriginal sentence ({source_language}): {sentence}\nTranslated sentence ({target_language}): {translation}\n\nIf accurate, return exactly: 'APPROVED'\nIf issues found, return specific feedback only as a string without any additional text.",
    "chunking": "You are a text processing assistant. Split the following text into chunks for translation. Each chunk should be semantically coherent (e.g., complete sentences or paragraphs) and not exceed {max_chunk_size} characters. Return ONLY a JSON object with a \"chunks\" key containing the list of chunks. Do not include any explanations or additional text.\n\nText:\n{text}",
